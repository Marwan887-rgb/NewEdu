// ════════════════════════════════════════════════════════════
// إعدادات بوت التلجرام - Telegram Bot Configuration (EXAMPLE)
// ════════════════════════════════════════════════════════════
// ⚠️ هذا ملف قالب - انسخه إلى config-telegram.js واملأ التوكن
// ════════════════════════════════════════════════════════════

const TELEGRAM_CONFIG = {
  // ⚠️ لا تضع التوكن هنا! استخدم localStorage أو .env.local
  // التوكن يُحفظ تلقائياً في localStorage عند استخدام telegram-setup.html
